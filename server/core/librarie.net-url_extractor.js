 ...
 *
 * */
var urls = ['/catalog-titluri.php?l=X', '/catalog-titluri.php?l=H'];
var sourcePage = "";
var crawlDepth = 0;
var nextPage = "";
var extractReviews;
...
//        }
        ...
        var id = agent.current.uri.match(/[http:\/\/]*www\.librarie\.net\/carti\/(\d+)\/[\d\D\S\s]+/i)[1];
        urls.push("/comentarii.php?id="+id+"&action=view");
    }
}